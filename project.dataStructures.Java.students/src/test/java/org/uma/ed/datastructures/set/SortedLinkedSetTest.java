...
class SortedLinkedSetTest {
  ...
  class TestCasesForMethodDelete {
    ...
    void whenASetHasOneElementWhenDeleteADifferentElementThenTheSetRemainsUnchanged() {
      // Arrange
      int element = 1 ;
      SortedSet<Integer> set = SortedLinkedSet.from(JDKArrayList.of(element));
    ...
    void whenASetHasFourElementWhenDeleteADifferentElementThenTheSetRemainsUnchanged() {
      // Arrange
      SortedSet<Integer> set = SortedLinkedSet.from(JDKArrayList.of(4,3,5,0));
    ...
    void whenASetHasThreeElementWhenDeleteThenTheFirstElementIsDeleted() {
      // Arrange
      SortedSet<Integer> set = SortedLinkedSet.from(JDKArrayList.of(4,3,5));
  ...
  class TestCasesForMethodMinimum {
    ...
    void whenTheSetHasOneElementThenThatElementIsReturned() {
      // Arrange
      double element = 5.5 ;
      SortedSet<Double> set = SortedLinkedSet.from(JDKArrayList.of(element));
    ...
    void whenTheSetHasSeveralElementsThenTheMinimumOneIsReturned() {
      // Arrange
      SortedSet<Double> set = SortedLinkedSet.from(JDKArrayList.of(5.6, 0.2, 4.9, 3.7));
  ...
  class TestCasesForMethodUnion {
    ...
    void whenTheSecondSetIsEmptyThenReturnsTheFirstSet() {
      // Arrange
      SortedSet<Integer> set1 = SortedLinkedSet.from(JDKArrayList.of(5,2,3,9)) ;
    ...
    void whenTheFirstSetIsEmptyThenReturnsTheSecondSet() {
      ...
      SortedSet<String> set2 = SortedLinkedSet.from(JDKArrayList.of("blue", "green", "white"));
    ...
    void whenTheSetsAreDisjointThenReturnsTheUnionSet() {
      // Arrange
      SortedSet<String> set1 = SortedLinkedSet.from(JDKArrayList.of("purple", "red")) ;
      SortedSet<String> set2 = SortedLinkedSet.from(JDKArrayList.of("blue", "green", "white"));
  ...
  class TestCasesForMethodIntersection {
    ...
    void whenTheSetsContainTheSameElementThenReturnsASetWithThatElement() {
      // Arrange
      SortedSet<Double> set1 = SortedLinkedSet.from(JDKArrayList.of(1.0));
      SortedSet<Double> set2 = SortedLinkedSet.from(JDKArrayList.of(1.0));
    ...
    void whenTheSetsShareAnElementThenReturnsTheUnionSet() {
      // Arrange
      SortedSet<String> set1 = SortedLinkedSet.from(JDKArrayList.of("purple", "red", "blue", "orange")) ;
  ...
  class TestCasesForMethodDifference {
    ...
    void whenTheSetsContainADifferentElementThenReturnsASetWithTheElementOfTheFirstSet() {
      // Arrange
      SortedSet<Double> set1 = SortedLinkedSet.from(JDKArrayList.of(2.0));
      SortedSet<Double> set2 = SortedLinkedSet.from(JDKArrayList.of(1.0));
