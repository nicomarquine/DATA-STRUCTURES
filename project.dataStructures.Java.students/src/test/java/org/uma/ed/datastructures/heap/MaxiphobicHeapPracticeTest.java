...
@DisplayName("Test cases for class MaxiphobicHeapPractice")
class MaxiphobicHeapPracticePracticeTest {

  @Nested
  @DisplayName("A MaxiphobicHeapPractice is created")
  class TestCasesForCreation {
    ...
    void whenConstructorIsCalledThenAHeapIsCreated() {
      Heap<Integer> heap = new MaxiphobicHeapPractice<Integer>(Comparator.naturalOrder());
      assertNotNull(heap);
    ...
    void whenEmptyWithComparatorIsCalledThenAHeapIsCreated() {
      ...
      Heap<String> heap = MaxiphobicHeapPractice.empty(reverseOrder);
      assertNotNull(heap);
      assertTrue(heap.isEmpty());
    ...
    void whenEmptyIsCalledThenAHeapIsCreated() {
      Heap<Integer> heap = MaxiphobicHeapPractice.empty();
      assertNotNull(heap);
      assertTrue(heap.isEmpty());
    ...
    void whenOfIsCalledThenAHeapIsCreated() {
      Heap<String> heap = MaxiphobicHeapPractice.of("orange", "blue", "green");
      assertNotNull(heap);
    ...
    void whenOfIsCalledWithDuplicatesThenDuplicatesAreIncluded() {
      Heap<Integer> heap = MaxiphobicHeapPractice.of(5, 3, 2, 1, 3, 5, 8);
    ...
    void givenAnIterableWhenFromIsCalledThenAHeapIsCreated() {
      ...
      Heap<Integer> heap = MaxiphobicHeapPractice.from(initialValues);
      assertNotNull(heap);
  ...
  class StaticMergeMethodTest {
    ...
    void setup() {
      ...
      for (Method method : MaxiphobicHeapPractice.class.getDeclaredMethods()) {
     ...
     */
    private <T> List<T> drainHeap(MaxiphobicHeapPractice<T> heap) {
    ...
    void staticMergeWithEmptyList() throws ReflectiveOperationException {
      ...
      MaxiphobicHeapPractice<Integer> resultHeap = (MaxiphobicHeapPractice<Integer>) staticMergeMethod.invoke(
    ...
    void staticMergeWithEvenNumberOfNodes() throws ReflectiveOperationException {
      ...
      @SuppressWarnings("unchecked")
      MaxiphobicHeapPractice<Integer> heapToInspect = (MaxiphobicHeapPractice<Integer>) staticMergeMethod.invoke(
          null, Comparator.naturalOrder(), nodes);
  ...
  class TestCasesForCopyOf {
    ...
    void givenAnEmptyHeapWhenCopyOfThenTheNewHeapIsAlsoEmpty() {
      MaxiphobicHeapPractice<Integer> heap = MaxiphobicHeapPractice.empty();
      MaxiphobicHeapPractice<Integer> copiedHeap = MaxiphobicHeapPractice.copyOf(heap);
    ...
    void givenANonEmptyHeapWhenCopyOfThenTheNewHeapIsEqualInContent() {
      MaxiphobicHeapPractice<Integer> heap = MaxiphobicHeapPractice.of(30, 10, 20);
      MaxiphobicHeapPractice<Integer> copiedHeap = MaxiphobicHeapPractice.copyOf(heap);
  ...
  class TestCasesForBasicProperties {
    ...
    void whenClearIsCalledThenTheHeapIsEmpty() {
      Heap<Integer> heap = MaxiphobicHeapPractice.of(1, 2, 3);
      assertFalse(heap.isEmpty());
      heap.clear();
      assertTrue(heap.isEmpty());
      assertEquals(0, heap.size());
  ...
  class TestCasesForCoreOperations {
    ...
    void whenMinimumIsCalledThenSizeIsUnchanged() {
      Heap<Integer> heap = MaxiphobicHeapPractice.of(10, 20);
      assertEquals(10, heap.minimum());
      assertEquals(2, heap.size());
    }
    ...
    void whenDeleteMinimumIsCalledThenMinimumIsRemoved() {
      Heap<Integer> heap = MaxiphobicHeapPractice.of(10, 20, 5);
    ...
    void whenDrainingTheHeapElementsAreSorted() {
      Heap<Integer> heap = MaxiphobicHeapPractice.of(5, 1, 4, 2, 3, 3);
  ...
  class StructuralIntegrityTests {
    ...
    class MergeMethodBaseCases {
      private MaxiphobicHeapPractice<Integer> heapInstance;
    ...
    class MergeMethodRecursiveLogic {
      private Object buildTreeOfWeight(int targetWeight, int value) throws ReflectiveOperationException {
        ...
        MaxiphobicHeapPractice<Integer> heap = createHeap();
      ...
      private void assertMaxiphobicMergeLogic(Object candidate1, Object candidate2, Object candidate3) throws ReflectiveOperationException {
        MaxiphobicHeapPractice<Integer> heapInstance = createHeap();
    ...
    class AfterRandomModification {
      ...
      void randomOperationsMaintainInvariants() throws ReflectiveOperationException {
        MaxiphobicHeapPractice<Integer> heap = MaxiphobicHeapPractice.of(100, 20, 50, 10, 80);
  ...
  private static Class<?> getNodeClass() throws NoSuchFieldException {
    Field rootField = MaxiphobicHeapPractice.class.getDeclaredField("root");
    return rootField.getType();
  }

  private static Object getRootNode(MaxiphobicHeapPractice<?> heap) throws ReflectiveOperationException {
    Field rootField = MaxiphobicHeapPractice.class.getDeclaredField("root");
  ...
  private static Method getMergeMethod() throws NoSuchMethodException, NoSuchFieldException {
    ...
    Method mergeMethod = MaxiphobicHeapPractice.class.getDeclaredMethod("merge", nodeClass, nodeClass);
  ...
  private static MaxiphobicHeapPractice<Integer> createHeap() {
    return MaxiphobicHeapPractice.<Integer>empty(Comparator.naturalOrder());
  }
